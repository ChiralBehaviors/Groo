...
public class Groo implements MBeanServerInterceptor {
    ...
    private static void checkMBeanPermission(String classname, String member,
        ...
        SecurityManager sm = System.getSecurityManager();
        if (sm != null) {
            Permission perm = new MBeanPermission(classname, member,
                                                  objectName, actions);
    ...
    private static void postRegister(ObjectName logicalName,
                                     DynamicMBean mbean,
    ...
    private static String safeGetClassName(DynamicMBean mbean) {
        try {
            ...
            if (MBEANSERVER_LOGGER.isLoggable(Level.FINEST)) {
                MBEANSERVER_LOGGER.logp(Level.FINEST, Groo.class.getName(),
                                        "safeGetClassName",
    ...
    public Groo(MBeanServer outer, MBeanServerDelegate delegate,
        ...
        domain = repository.getDefaultDomain();
    }
    ...
    public void addNotificationListener(ObjectName name,
        ...
        if (MBEANSERVER_LOGGER.isLoggable(Level.FINER)) {
            MBEANSERVER_LOGGER.logp(Level.FINER, Groo.class.getName(),
    ...
    public String[] getDomains() {
        ...
        if (sm != null) {
            ...
            for (String domain2 : domains) {
                try {
                    ObjectName dom = Util.newObjectName(domain2 + ":x=x");
    ...
    public boolean isInstanceOf(ObjectName name, String className)
        ...
        try {
            ...
            final String resourceClassName = resource instanceof DynamicMBean ? getClassName((DynamicMBean) resource)
    ...
    public Set<ObjectInstance> queryMBeans(ObjectName name, QueryExp query) {
        ...
        if (sm != null) {
            ...
            Set<ObjectInstance> allowedList = new HashSet<ObjectInstance>(
                                                                          list.size());
    ...
    private ObjectInstance createMBean(String className, ObjectName name,
        ...
        Object moi = instantiator.instantiate(theClass,
                                              params,
                                              signature,
                                              server.getClass().getClassLoader());
    ...
    private NotificationListener getListener(ObjectName listener)
        ...
        try {
            ...
            throw EnvHelp.initCause(new ListenerNotFoundException(
                                                                  e.getMessage()),
                                    e);
        }
